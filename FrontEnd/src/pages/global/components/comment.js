                  ...
                  <div className="Body">
                    ...
                    {(!this.state.reply && !this.state.edit) && (
                      <div className="Actions">
                        ...
                        <div className="ActionButton"><ShareButton {...this.props} mini={true} title={`${this.props.comment.user.username}'s comment on Source`} url={`${window.location.href}#${this.props.comment._id}`}/></div>
                        {!this.state.minimised && (
                          <div>
                            {this.props.comment.user._id===this.props.user.id && (
                              <div className="Flex">
                                ...
                                <DeleteButton delete={this.deleteComment} mini={true}/>
                              </div>
                            )}
                          </div>
                        )}
