...
class SearchResults extends Component {
  ...
  handleSortChange(event) {
    ...
    if (event.target.value !== this.state.sort) {
      if (this.state.sort==="newest") {
        if (this.state.tag==='') {this.props.searchRequest(undefined,undefined,undefined)}
        else {this.props.searchRequest(undefined,undefined,[this.state.tag])}
      } else {
        if (this.state.tag==='') {this.props.searchRequest(undefined,this.state.sort,undefined)}
        else {this.props.searchRequest(undefined,this.state.sort,[this.state.tag])}
      }
    }
  };
