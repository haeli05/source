          ...
          <ClickAwayListener onClickAway={this.handleClick}>
            <Grow in={this.state.open}>
              <Paper className="ShareIcons" elevation={0}>
                <FacebookShareButton className="SocialButtonLast" url={this.state.url} quote={this.state.title} hashtag='Source'><FacebookIcon round={true} size={32} /></FacebookShareButton>
                <TwitterShareButton className="SocialButton" url={this.state.url} title={this.state.title} via="Source_platform" hashtags={['Source']}><TwitterIcon round={true} size={32} /></TwitterShareButton>
                <LinkedinShareButton className="SocialButton" url={this.state.url} title={this.state.title} ><LinkedinIcon round={true} size={32} /></LinkedinShareButton>
                <TelegramShareButton className="SocialButton" url={this.state.url} title={this.state.title}><TelegramIcon round={true} size={32} /></TelegramShareButton>
                <VKShareButton className="SocialButton" url={this.state.url} title={this.state.title}><VKIcon round={true} size={32} /></VKShareButton>
                <RedditShareButton className="SocialButton" url={this.state.url} title={this.state.title}><RedditIcon round={true} size={32} /></RedditShareButton>
                <WhatsappShareButton className="SocialButton" url={this.state.url} title={this.state.title}><WhatsappIcon round={true} size={32} /></WhatsappShareButton>
                <EmailShareButton className="SocialButton" url={this.state.url} subject={this.state.title}><EmailIcon round={true} size={32} /></EmailShareButton>
              </Paper>
            </Grow>
          </ClickAwayListener>
        )}
