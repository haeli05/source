        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.props.repos !== false && this.props.repos !== undefined && this.props.repos.map(function (repo) {
              var truth = false;
              if (_this2.props.user.user !== false && _this2.props.user.user !== undefined) if (_this2.props.user.user.starred.includes(repo.repoID.toString())) {
                truth = true;
              }
              return _react2.default.createElement(_repoCard2.default, {
                key: repo.repoID, id: repo.repoID,
                cid: repo.cid, starred: truth,
                handleStar: _this2.handleStar,
                props: _this2.props, RepoName: repo.project_name,
                RepoAuthor: repo.username, RepoDescription: "Best Repo",
                Language: "Put me in coach!", Forks: repo.forks_count,
                Issues: "Put me in coach!", SRCRaised: repo.src_raised,
